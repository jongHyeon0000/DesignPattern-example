...
//           getInstance(Line 10)를 클라이언트에서 사용하기 위해 호출하는 순간 
//           LazyHolder(Line 14)클래스가 클래스 로더(Class Loader)에 의해 메소드 영역(Method Area)에 올라가게 된다.
//           이 때 LazyHolder(Line 14)클래스의 instance에 싱글톤 객체가 할당되기 때문에,
